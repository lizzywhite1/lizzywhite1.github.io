...
\textbf{y}\end{pmatrix}\implies \Phi^T\Phi \theta=\Phi\textbf{y}\implies \hat{\theta}=(\Phi ^T\Phi)^{-1}\Phi^T\textbf{y}.$$
...
$$\textbf{y}=\Phi\theta + \textbf{\epsilon}$$
...
[^3]: This is often used interchangably with the term "_residual_", however, they are different. The residual refers to the
difference between the model prediction and the true value whereas the error refers to difference between the observed value 
